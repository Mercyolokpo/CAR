...
def main():
    ...
    <h2 style = "color:black;text-align:center;"> Mercy Car Price Prediction Web App </h2>
    </div>
    """
    
    model = xgb.XGBRegressor()
    model.load_model('C:/Users/user/Desktop/Data Science Materials/MERCY OLOKPO/xg_model.json')
